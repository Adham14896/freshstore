...
export default function RelatedProduct({ product }) {
  const { wishList, addToWishList, deleteFromWishList } =
  ...
  return (
    <>
      <div className="w-full md:w-1/2 lg:w-1/5 product">
        <Link to={`/productdetails/${product.id}`}>
          ...
          <h2 className="mt-2 mx-2 text-sm font-medium text-green-500">
